...
class ReviewQueueEntry {
  ...
  /// **最新のジョブが失敗した設問の数。** 0でなければ、この答案はいま人の手では
  /// 確定できない (Issue #118: AI採点が失敗した設問に点数を入れる経路がまだ無い)。
  ///
  /// 「後回しにした答案」と区別するためにある。後回しは人が順番を変えただけで
  /// 状態を持たないが、こちらは**放っておくと永久に終わらない**。金曜の午後の
  /// 終わりに「残り3枚」を見たとき、この2つは読み分けられなければならない。
  ...
  /// AI採点が失敗した設問を抱えている。
  bool get isStuck => failedQuestions > 0;
