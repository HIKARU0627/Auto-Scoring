...
class RecognitionsApi {
  ...
  const RecognitionsApi(this._dio, this._serializers);
  ...
  Future<Response<RecognitionResponse>>
      createManualRecognitionSubmissionsSubmissionIdQuestionsQuestionIdRecognitionsPost({
    required String submissionId,
    required String questionId,
    required ManualRecognitionRequest manualRecognitionRequest,
    ...
    final _path =
        r'/submissions/{submission_id}/questions/{question_id}/recognitions'
            .replaceAll(
                '{' r'submission_id' '}',
    ...
    try {
      const _type = FullType(ManualRecognitionRequest);
      _bodyData = _serializers.serialize(manualRecognitionRequest,
          specifiedType: _type);
  ...
  Future<Response<Uint8List>>
    ...
    final _path =
        r'/submissions/{submission_id}/questions/{question_id}/answer-image'
            .replaceAll(
                '{' r'submission_id' '}',
                encodeQueryParameter(
                        _serializers, submissionId, const FullType(String))
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<RecognitionResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<RecognitionResponse>>>
    ...
    BuiltList<RecognitionResponse>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as BuiltList<RecognitionResponse>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<RecognitionResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
