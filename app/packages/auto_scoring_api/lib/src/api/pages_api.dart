...
class PagesApi {
  ...
  Future<Response<Uint8List>>
    ...
    final _path =
        r'/tests/{test_id}/materials/{material_id}/pages/{page_index}/image'
            .replaceAll(
                '{' r'test_id' '}',
                encodeQueryParameter(
                        _serializers, testId, const FullType(String))
                    .toString())
            .replaceAll(
                '{' r'material_id' '}',
                encodeQueryParameter(
                        _serializers, materialId, const FullType(String))
                    .toString())
            .replaceAll(
                '{' r'page_index' '}',
                encodeQueryParameter(
                        _serializers, pageIndex, const FullType(int))
                    .toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
  ...
  Future<Response<DocumentPagesResponse>>
    ...
    final _path = r'/tests/{test_id}/materials/{material_id}/pages'
        .replaceAll(
            '{' r'test_id' '}',
            encodeQueryParameter(_serializers, testId, const FullType(String))
                .toString())
