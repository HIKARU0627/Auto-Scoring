...
class ExportApi {
  ...
  Future<Response<Uint8List>> getExportFileExportsExportIdFileGet({
    ...
    final _path = r'/exports/{export_id}/file'.replaceAll(
        '{' r'export_id' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ExportResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ExportResponse>>>
    ...
    final _path = r'/submissions/{submission_id}/exports'.replaceAll(
        '{' r'submission_id' '}',
    ...
    BuiltList<ExportResponse>? _responseData;
    ...
    return Response<BuiltList<ExportResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BulkExportResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BulkExportResponse>> requestBulkExportTestsTestIdExportPost({
    ...
    final _path = r'/tests/{test_id}/export'.replaceAll(
        '{' r'test_id' '}',
    ...
    try {
      const _type = FullType(BulkExportRequest);
      _bodyData = bulkExportRequest == null
          ? null
          : _serializers.serialize(bulkExportRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    BulkExportResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BulkExportResponse),
    ...
    return Response<BulkExportResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ExportRequestResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExportRequestResponse>>
    ...
    final _path = r'/submissions/{submission_id}/export'.replaceAll(
        '{' r'submission_id' '}',
        encodeQueryParameter(_serializers, submissionId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ExportRequestResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ExportRequestResponse),
    ...
    return Response<ExportRequestResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
