...
class JobsApi {
  ...
  Future<Response<JobResponse>> cancelJobJobsJobIdCancelPost({
    ...
    final _path = r'/jobs/{job_id}/cancel'.replaceAll(
        '{' r'job_id' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<JobResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<JobResponse>>>
    ...
    final _path = r'/submissions/{submission_id}/jobs'.replaceAll(
        '{' r'submission_id' '}',
    ...
    BuiltList<JobResponse>? _responseData;
    ...
    return Response<BuiltList<JobResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JobResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JobResponse>> getJobJobsJobIdGet({
    required String jobId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/jobs/{job_id}'.replaceAll(
        '{' r'job_id' '}',
        encodeQueryParameter(_serializers, jobId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<void>>
    ...
    final _path = r'/submissions/{submission_id}/questions/{question_id}/resume'
        .replaceAll(
            '{' r'submission_id' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [JobResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JobResponse>> retryJobJobsJobIdRetryPost({
    required String jobId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/jobs/{job_id}/retry'.replaceAll(
        '{' r'job_id' '}',
        encodeQueryParameter(_serializers, jobId, const FullType(String))
            .toString());
    final _options = Options(
