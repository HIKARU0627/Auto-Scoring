...
class CriteriaApi {
  ...
  const CriteriaApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CriteriaResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CriteriaResponse>>
      confirmCriteriaTestsTestIdCriteriaConfirmPost({
    required String testId,
    required ConfirmCriteriaRequest confirmCriteriaRequest,
    ...
    final _path = r'/tests/{test_id}/criteria/confirm'.replaceAll(
        '{' r'test_id' '}',
    ...
    try {
      const _type = FullType(ConfirmCriteriaRequest);
      _bodyData =
          _serializers.serialize(confirmCriteriaRequest, specifiedType: _type);
    ...
    CriteriaResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CriteriaResponse),
            ) as CriteriaResponse;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<CriteriaResponse>>
    ...
    final _path = r'/tests/{test_id}/criteria/extract'.replaceAll(
        '{' r'test_id' '}',
        encodeQueryParameter(_serializers, testId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [CriteriaResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CriteriaResponse>> getCriteriaTestsTestIdCriteriaGet({
    required String testId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/tests/{test_id}/criteria'.replaceAll(
        '{' r'test_id' '}',
        encodeQueryParameter(_serializers, testId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [CriteriaResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CriteriaResponse>> updateCriteriaTestsTestIdCriteriaPut({
    required String testId,
    required UpdateCriteriaRequest updateCriteriaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCriteriaRequest);
      _bodyData =
          _serializers.serialize(updateCriteriaRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
