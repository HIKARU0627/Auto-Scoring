...
class ErrorCatalogApi {
  ...
  const ErrorCatalogApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ErrorCatalogResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ErrorCatalogResponse>>
    ...
    final _path = r'/tests/{test_id}/error-catalog'.replaceAll(
        '{' r'test_id' '}',
    ...
    ErrorCatalogResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ErrorCatalogResponse),
            ) as ErrorCatalogResponse;
    ...
    return Response<ErrorCatalogResponse>(
      data: _responseData,
  ...
  Future<Response<ErrorCatalogResponse>>
    ...
    required String testId,
    required ImportErrorCatalogRequest importErrorCatalogRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/tests/{test_id}/error-catalog/import'.replaceAll(
        '{' r'test_id' '}',
        encodeQueryParameter(_serializers, testId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(ImportErrorCatalogRequest);
      _bodyData = _serializers.serialize(importErrorCatalogRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<ErrorCatalogResponse>>
    ...
    required String testId,
    required SaveErrorCatalogRequest saveErrorCatalogRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SaveErrorCatalogRequest);
      _bodyData =
          _serializers.serialize(saveErrorCatalogRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
