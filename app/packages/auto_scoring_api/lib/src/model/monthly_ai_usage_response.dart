...
part 'monthly_ai_usage_response.g.dart';
...
/// * [usageAvailability]
@BuiltValue()
abstract class MonthlyAiUsageResponse
    implements Built<MonthlyAiUsageResponse, MonthlyAiUsageResponseBuilder> {
  ...
  MonthlyAiUsageResponse._();

  factory MonthlyAiUsageResponse(
          [void updates(MonthlyAiUsageResponseBuilder b)]) =
      _$MonthlyAiUsageResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MonthlyAiUsageResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MonthlyAiUsageResponse> get serializer =>
      _$MonthlyAiUsageResponseSerializer();
}

class _$MonthlyAiUsageResponseSerializer
    implements PrimitiveSerializer<MonthlyAiUsageResponse> {
  @override
  ...
  @override
  final String wireName = r'MonthlyAiUsageResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MonthlyAiUsageResponse object, {
  ...
  void _deserializeProperties(
    ...
    required MonthlyAiUsageResponseBuilder result,
  ...
  @override
  MonthlyAiUsageResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MonthlyAiUsageResponseBuilder();
